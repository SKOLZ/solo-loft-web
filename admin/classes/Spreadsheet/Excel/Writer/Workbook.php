...
require_once $PATH_ONAS.'/classes/Spreadsheet/Excel/Writer/Format.php';
require_once $PATH_ONAS.'/classes/Spreadsheet/Excel/Writer/BIFFwriter.php';
require_once $PATH_ONAS.'/classes/Spreadsheet/Excel/Writer/Worksheet.php';
require_once $PATH_ONAS.'/classes/Spreadsheet/Excel/Writer/Parser.php';
require_once $PATH_ONAS.'/classes/OLE/PPS/Root.php';
require_once $PATH_ONAS.'/classes/OLE/PPS/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
	...
	var $_tmp_dir; // Se lo agregue porque no se que onda.. en el server no anda
