...
(function($) {
	...
	$.extend(MediaElementPlayer.prototype, {
		...
		enterFullScreen: function() {
			...
			$('#header').css({'top':-100});
			if ($('.home-slideshow-holder').length) {
				$('.home-slideshow-holder').css({'margin-top':0,'height':$(window).height()});
				$('video').css({'width':$(window).width()});
				videoPlayer.adjustSize(false,$(window).height());
			}
			console.log('mjs 1');
		...
		exitFullScreen: function() {
			...
			if ($('.home-slideshow-holder').length) {
				$('.home-slideshow-holder').css({'margin-top':35,'height':$(window).height()-35});
				$('video').css({'width':$(window).width()});
				videoPlayer.adjustSize(false,$(window).height()-35);
			}
